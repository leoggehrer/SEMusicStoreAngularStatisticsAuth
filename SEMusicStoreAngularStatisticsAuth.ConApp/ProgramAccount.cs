#if ACCOUNT_ON
namespace SEMusicStoreAngularStatisticsAuth.ConApp
{
    partial class Program
    {
        ...
        /// </summary>
        private static string AMUser => "AppManager";
        /// <summary>
        /// Represents the email address used by the application.
        /// </summary>
        private static string AMEmail => "AppManager@gmx.at";

        /// <summary>
        /// Gets or sets the application password.
        /// </summary>
        private static string AMPwd => "1234AppManager";
        /// <summary>
        /// Gets the application role.
        /// </summary>
        private static string AMRole => "AppManager";
        ...
        static partial void CreateAccounts()
        {
            Task.Run(async () =>
            {
                ...
                await AddAppAccessAsync(SAEmail, SAPwd, AMUser, AMEmail, AMPwd, 35, AMRole);
