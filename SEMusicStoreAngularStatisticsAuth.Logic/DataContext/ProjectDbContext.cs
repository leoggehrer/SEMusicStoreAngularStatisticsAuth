//@CodeCopy
using SEMusicStoreAngularStatisticsAuth.Common.Modules.Exceptions;
using SEMusicStoreAngularStatisticsAuth.Logic.Contracts;
using System.Reflection;

namespace SEMusicStoreAngularStatisticsAuth.Logic.DataContext
{
    /// <summary>
    /// Represents the database context for the SEMusicStoreAngularStatisticsAuth application.
    /// </summary>
    internal sealed partial class ProjectDbContext : DbContext, IContext
    {
        ...
        /// </summary>
        private static readonly string ConnectionString = "data source=SEMusicStoreAngularStatisticsAuth.db";
        #endregion fields
