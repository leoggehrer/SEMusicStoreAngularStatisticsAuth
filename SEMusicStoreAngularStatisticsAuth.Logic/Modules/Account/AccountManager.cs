//@CodeCopy
#if ACCOUNT_ON
using SEMusicStoreAngularStatisticsAuth.Logic.Entities.Account;
using SEMusicStoreAngularStatisticsAuth.Logic.Modules.Exceptions;
using SEMusicStoreAngularStatisticsAuth.Logic.Modules.Security;
using System.Text;
using System.Text.RegularExpressions;

namespace SEMusicStoreAngularStatisticsAuth.Logic.Modules.Account
{
    using PasswordRules = CommonModules.Security.PasswordRules;
    using Error = CommonModules.Exceptions.ErrorType;
    using System.Reflection;
    using SEMusicStoreAngularStatisticsAuth.Common.Modules.ThreadSafe;
