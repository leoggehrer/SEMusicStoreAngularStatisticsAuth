...
import { IAlbumStatistic } from '@app/models/entities/views/i-album-statistic';
import { AlbumStatisticService } from '@app/services/http/entities/views/album-statistic-service';

/* Ersetzen Sie hier 'IViewEntity' durch den gewuenschten 'Type' (z.B.: 'IAlbum') */
interface IItem extends IAlbumStatistic {

}
/* Ersetzen Sie in Component 'item-view' durch den gewuenschten Namen (z.B.: genre-statistics) */
@Component({
    selector: 'app-album-statistic-list',
    imports: [CommonModule, FormsModule],
    templateUrl: './album-statistic-list.component.html',
    styleUrl: './album-statistic-list.component.css'
})
export class AlbumStatisticListComponent extends GenericViewListComponent<IItem> implements OnInit {

    constructor(
        protected override modal: NgbModal,
        protected dataAccessService: AlbumStatisticService,
